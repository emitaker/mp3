...
playlist = 1 #default playlist

sound = 60 #default volume

screen = pygame.display.set_mode((800, 650))#screen resolution: 800 width x 650 height

def init():
    """Defining all the GPIO ports"""
...
def slowed_reverb():
    """Defines slowed & reverb as current playlist"""
    global playlist
    playlist = 1
    print(playlist)
...
def slowed_reverb_screen():
    """Drawing the slowed & reverb playlist screen"""
    screen.fill(('#111010'))
...
def live():
    """Defines live music as current playlist"""
    global playlist
    playlist = 2
    print(playlist)
...
def live_screen():
    """Drawing the live music playlist screen"""
    screen.fill(('#111010'))
    font = pygame.font.SysFont(None, 48)
...
def classic():
    """Defines classic music as current playlist"""
    global playlist
    playlist = 3
    print(playlist)
...
def classic_screen():
    """Drawing the classic music playlist screen"""
    screen.fill(('#111010'))
    font = pygame.font.SysFont(None, 48)
...
def rock():
    """Defines rock music as current playlist"""
    global playlist
    playlist = 4
    print(playlist)
...
def rock_screen():
    """Drawing the rock music playlist screen"""
    screen.fill(('#111010'))
    font = pygame.font.SysFont(None, 48)
...
def play():
    """Plays the first song of the playlist when the button is pushed"""
    if (playlist == 1):
...
def skip():
    """Pass to the next song of the playlist"""
    if (playlist == 1):
...
def prev():
    """Return to the previous song of the playlist"""
    if (playlist == 1):
...
def shuffle():
    """Plays a random song of the current playlist"""
