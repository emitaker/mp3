...
def slowed_reverb_screen():
    ...
    #Musicicon2
    image = pygame.image.load('/home/pi/Documents/mp3/pics/slowed&reverb.jpg')
    image.convert()
    image = pygame.transform.scale(image, (50,50))
    screen.blit(image, (50,55))
    image = pygame.image.load('/home/pi/Documents/mp3/pics/pausab.png')
    image.convert()
    image = pygame.transform.scale(image, (65,65))
    screen.blit(image, (375,450))
    image = pygame.image.load('/home/pi/Documents/mp3/pics/playb.png')
    image.convert()
    image = pygame.transform.scale(image, (65,65))
    screen.blit(image, (310,451))
    image = pygame.image.load('/home/pi/Documents/mp3/pics/prevsi.png')
    image.convert()
    image = pygame.transform.scale(image, (62,62))
    screen.blit(image, (242,452))
    image = pygame.image.load('/home/pi/Documents/mp3/pics/ffsi.png')
    image.convert()
    image = pygame.transform.scale(image, (58,58))
    screen.blit(image, (445,452))
    image = pygame.image.load('/home/pi/Documents/mp3/pics/shufflew.png')
    image.convert()
    image = pygame.transform.scale(image, (50,50))
    screen.blit(image, (512,456))
    image = pygame.image.load('/home/pi/Documents/mp3/pics/vol.png')
    image.convert()
    image = pygame.transform.scale(image, (50,50))
...
def live_screen():
    ...
    screen.blit(img, (110,65))
    #Musicicon2
    image = pygame.image.load('/home/pi/Documents/mp3/pics/live.jpg')
    image.convert()
    image = pygame.transform.scale(image, (50,50))
    screen.blit(image, (50,55))
    image = pygame.image.load('/home/pi/Documents/mp3/pics/pausab.png')
...
def classic_screen():
    ...
    screen.blit(img, (110,65))
    #Musicicon2
    image = pygame.image.load('/home/pi/Documents/mp3/pics/classicmusic.jpg')
    image.convert()
    image = pygame.transform.scale(image, (50,50))
    screen.blit(image, (50,55))
    image = pygame.image.load('/home/pi/Documents/mp3/pics/pausab.png')
...
def rock_screen():
    ...
    screen.blit(img, (110,65))
    #Musicicon2
    image = pygame.image.load('/home/pi/Documents/mp3/pics/ock.jpg')
    image.convert()
    image = pygame.transform.scale(image, (50,50))
    screen.blit(image, (50,55))
    image = pygame.image.load('/home/pi/Documents/mp3/pics/pausab.png')
